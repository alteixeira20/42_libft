...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/10/27 01:35:47 by paalexan          #+#    #+#              #
#    Updated: 2025/01/29 01:15:27 by paalexan         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
cc -Wall -Wextra -Werror -o tests tests.c $TEST_FILES $LIBFT_PATH -lbsd
...
rm -f test_putchar_fd.txt test_putstr_fd.txt test_putendl_fd.txt test_putnbr_fd.txt
